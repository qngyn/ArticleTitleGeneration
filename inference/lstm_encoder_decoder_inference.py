...
# This notebook includes code to build and train model 1 
# (model with stacked LSTM encoder and 1-layer LSTM decoder with Bahdanau Attention), 
...
decoder_hidden_state_input = Input(shape=(max_len_full_article, latent_dim), name="input_5")
